...
export default function About() {
    ...
    <div className="w-full flex flex-col items-center text-center py-10">
      ...
      {selectedDot !== null && (
        <div className="max-w-2xl p-6 text-center">
          <h3 className="text-3xl font-bold border-4 border-double border-orange-500  ">{dots[selectedDot].title}</h3>
  ...
  <hr className="w-full h-2  border-t border-orange-500 absolute top-1/2  left-0 z-0" />
    ...
    <div key={index} className="relative flex flex-col  items-center">
      ...
      <button
        className={`w-6 h-6 rounded-full transition duration-200 ${
          selectedDot === index ? "bg-orange-300" : "bg-orange-500"
        }`}
